  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-if="checkPer(['admin','activityShareResultRecord:edit','activityShareResultRecord:del'])" label="操作" width="150px" align="center">
...
const defaultForm = { columnId: null, shareUserId: null, randomCode: null, userId: null, shareUrl: null }
export default {
  name: 'ActivityShareResultRecord',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: '分享结果记录', url: 'api/activityShareResultRecord', idField: 'columnId', sort: 'columnId,desc', crudMethod: { ...crudActivityShareResultRecord }})
  },
  data() {
    return {
      permission: {
