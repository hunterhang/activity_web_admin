  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column prop="shareParticipateNum" label="分享链接成功参与抽奖数" width="300" />
...
const defaultForm = { columnId: null, activityId: null, userId: null, shareClickNum: null, shareParticipateNum: null, shareUrl: null, randomCode: null, drawTime: null }
export default {
  name: 'UserActivityShareRecord',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: '分享记录表', url: 'api/userActivityShareRecord', idField: 'columnId', sort: 'columnId,desc', crudMethod: { ...crudUserActivityShareRecord }})
  },
  data() {
    return {
      permission: {
